...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "(int) outputs number of channels",
					"id" : "obj-14",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "(int) 1-8 sets number of channels",
					"id" : "obj-13",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Sets number of output channels your module has."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 75.0, 45.0, 36.0, 20.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 135.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					"activetricolor" : [ 0.987682, 0.278285, 0.112038, 1.0 ],
					"appearance" : 1,
					"id" : "obj-1",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 15.0, 105.0, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.0, 0.0, 36.0, 15.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 60.0, 72.0, 60.0, 72.0, 69.0, 84.5, 69.0 ],
					"source" : [ "obj-13", 0 ]
				}
