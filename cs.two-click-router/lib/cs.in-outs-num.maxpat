...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 187.0, 15.0, 0.0, 0.0 ]
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 65.0, 235.0, 69.0, 20.0 ],
													"text" : "unpack 2 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 80.0, 160.0, 40.0, 20.0 ],
													"text" : "zl.len"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 52.5, 315.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 196.0, 160.0, 139.0, 20.0 ],
...
,
									"text" : "p set-from-single-or-pair"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.0, 130.0, 114.0, 20.0 ],
													"text" : "v #1-out-chan-num"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 130.0, 106.0, 20.0 ],
													"text" : "v #1-in-chan-num"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 130.0, 165.0, 20.0 ],
									"text" : "sel bang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 196.0, 240.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 316.0, 240.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 130.0, 106.0, 20.0 ],
									"text" : "v #1-in-chan-num"
								}
...
,
					"text" : "p link-ins-and-outs"
				}

			}
, 			{
				"box" : 				{
					"comment" : "bang sends current values out outlet; int sets input number; list (2 ints) sets both input & output number",
					"id" : "obj-12",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(list) number of in- & outputs in 2-member list of ints on change",
					"id" : "obj-8",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-1" : [ "live.numbox[1]", "live.numbox", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "cs.ins-num.maxpat",
