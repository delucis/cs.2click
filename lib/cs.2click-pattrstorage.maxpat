...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 105.0, 92.0, 34.0 ],
...
,
					"text" : "pattrstorage routing-presets",
					"varname" : "routing-presets"
				}
...
,
					"text" : "pattr 2click-global-dictionary",
					"varname" : "2click-global-dictionary"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 219.0, 84.5, 219.0 ],
					"source" : [ "obj-17", 0 ]
				}
