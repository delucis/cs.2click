...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 45.0, 15.0, 330.0, 19.0 ],
									"text" : "if green value is > 0.75, make text black; if < 0.75, make text light",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 240.0, 105.0, 111.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 45.0, 44.0, 20.0 ],
									"text" : "> 0.75"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 105.0, 206.0, 20.0 ],
									"text" : "loadmess textcolor 0.96 0.96 0.96 1."
								}
...
,
					"patching_rect" : [ 15.0, 195.0, 115.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Helvetica Neue",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.5, 15.0, 270.0, 21.0 ],
					"text" : "cs.2click-led",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.5, 45.0, 449.5, 83.0 ],
					"text" : "Calculates “signal presence”. Signal with peaks above -60dB will start to light the LED green, with it being fully green from around -55dB onwards.\n\nIn presentation mode as a [bpatcher] the [panel] object will light green and is usable as a simple UI object. Included as an abstraction, the patcher outputs background and text colour messages to pass on to other interface objects.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 225.0, 200.0, 20.0 ],
					"text" : "loadmess bgcolor 0.25 0.25 0.25 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.5, 270.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 225.0, 135.0, 18.0 ],
					"text" : "bgcolor 0.25 $1 0.25 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 15.0, 165.0, 91.0, 20.0 ],
					"text" : "peakamp~ 250"
				}
